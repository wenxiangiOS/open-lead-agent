...
CORE84_CHAT_SCENARIO_IDS = [
    ...
    "humanlike_shadow_profile_location_to_occupation_bridge",
    "humanlike_occupation_income_main_slot_prefers_occupation",
    ...
    "ending_separation_should_end",
    "ending_both_contact_refused",
    "ending_both_contact_refused_without_contact_no_promise",
    ...
    "ending_spam_user",
    "ending_spam_user_variant",
    "ending_spam_user_aggressive",
    "ending_normal_complete",
    "ending_fake_info_pattern",
    "ending_gay_user_variant",
    "ending_divorce_incomplete_variant",
    "ending_proxy_user_variant",
]
SCENARIO_PACKS = {
    "core84": {
        "description": "05 + 06 完整方案核心场景包（历史名称 core84），含主线/联系方式/全部收尾场景",
