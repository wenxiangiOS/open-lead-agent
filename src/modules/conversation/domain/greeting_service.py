...
class GreetingService:
    ...
    GREETING_RESPONSES: Dict[str, List[str]] = {
        "formal": [
            "你好呀，我在呢。你可以先简单介绍下自己，我顺着了解会更自然一点。",
            "你好呀，在的。你先简单说说自己就行，我顺着了解会更顺一点。",
            "你好呀，我在。你可以先讲讲自己的大概情况，我顺着往下了解。",
            "你好呀，在呢。你先说说你自己的情况吧，我这边顺着了解，也更自然。",
            "你好呀，我在呢。你可以先简单介绍下自己，后面我也更好往合适的方向帮你看。",
        ],
        "casual": [
            "在呢，你可以先简单介绍下自己，我顺着了解就行。",
            "在呀，你先随便说说自己的情况，我这边顺着跟你聊。",
            "我在呢，你先简单讲讲自己吧，我顺着了解会更轻松一点。",
            "在的，你先说说你自己，我这边顺着往下聊。",
            "我在呀，你先简单介绍下自己，我顺着了解会自然一点。",
        ],
        "time_morning": [
            "早上好呀～我在呢。你可以先简单介绍下自己，我顺着了解会更自然一点。",
            "早安～今天我们轻松聊，你先讲讲自己的情况就行，我顺着往下了解。",
            "早上好呀～你先简单说说自己吧，我这边顺着了解会更顺一点。",
        ],
        "time_afternoon": [
            "下午好呀～我在。你先简单说说自己，我顺着了解会更自然一点。",
            "下午好～可以先聊聊你自己的情况，我这边顺着帮你往下理。",
            "下午好呀～你先讲讲自己的大概情况吧，我顺着了解就行。",
        ],
        "time_evening": [
            "晚上好呀～我在呢。你先简单介绍下自己吧，我顺着了解会轻松一点。",
            "晚上好～别有压力，你先说说自己的情况，我顺着往下聊。",
            "晚上好呀～你先简单讲讲自己，我这边顺着了解就行。",
        ],
        "light_consult": [
            "可以呀，你可以先简单介绍下自己，我顺着了解会更自然一点。",
            "当然可以，你先说说你自己的情况，我这边顺着跟你聊就行。",
            "可以呀，你先简单讲讲自己，我顺着了解，也更好往合适的方向帮你看。",
        ],
    }
