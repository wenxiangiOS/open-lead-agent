...
class UserQuestionService:
    ...
    FAQ_RESPONSE_RULES = (
        ...
        (
            ...
            (
                "我们是同城脱单联盟的，帮男生女生脱单的",
                "我们是做同城脱单匹配的，主要帮本地单身男生女生牵线认识。不是那种广撒网式中介，都会先把你的情况和想法聊清楚，再看怎么往下安排",
                "我们是做同城脱单匹配的，主要帮男生女生脱单牵线。不是那种只管推人的中介，会先把情况了解清楚再往下走",
            ),
        ),
        (
            "fee",
            ...
            (
                "是否收费是看小姐姐有没有选择我们的高端定制服务，有选择就有的，没有选择就没有的，一切看你个人意愿的",
