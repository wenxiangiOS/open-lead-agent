...
class UserQuestionService:
    ...
    FAQ_RESPONSE_RULES = (
        ...
        (
            ...
            (r'中介吗', r'你们是做什么的'),
            (
                "我们主要是先把你的情况和想法聊清楚，再看后面怎么继续，不是那种广撒网式中介。你担心哪块我可以直接讲清楚。",
                "你可以把我们理解成先帮你把情况捋顺、把沟通节奏理顺，不是那种只管到处推人的做法。",
                "我们不是那种一上来就乱推荐的中介方式，更像先把情况聊明白，再决定后面怎么往下走。",
            ),
        ),
        (
            "fee",
        ...
        (
            ...
            (
                "这个不会一上来就直接加对方微信，前面会先把双方情况沟通清楚；后面如果真要继续，也会先和你确认。",
                "一般不会现在就直接互加微信，前面还是先沟通和确认；后面如果双方都愿意，再决定怎么继续。",
                "不会一开始就直接给对方微信，前面会先把沟通情况和双方意愿确认清楚，再往后安排。",
            ),
        ),
        (
            "photo",
        ...
        (
            ...
            (r'成功率', r'脱单率'),
            (
                "这种事还是得看双方是不是聊得来，不过我们会尽量把不合适的情况提前过滤掉。你要是还有顾虑也可以继续问我。",
        ...
        (
            ...
            (r'多久能找到', r'时间', r'周期'),
            (
                "这块没有固定时长，主要还是看资料情况和后续沟通节奏。你要是还有顾虑也可以继续问我。",
        ...
        (
            ...
            (r'靠谱吗', r'真的假的', r'安全吗'),
            (
                "你这个顾虑很正常，我们会先把信息和沟通节奏把住，安全和靠谱会放在前面。你要是还有顾虑也可以继续问我。",
