...
class UserQuestionService:
    ...
    FAQ_RESPONSE_RULES = (
        ...
        (
            ...
            (
                "一般是先把你的基本情况和要求聊清楚，再看后面怎么继续推进；合不合适你都可以自己决定。",
        ...
        (
            ...
            (r'能加对方微信', r'能直接联系'),
            (
                "不是一开始就直接互加，前面会先把双方情况聊清楚，避免一上来直接联系会尴尬。",
                "这类联系方式不会现在就直接给出去，前面会先沟通清楚；后面如果真有必要，也会先和你确认。",
                "一般不会上来就直接互加，前面还是先看彼此意愿和沟通情况，再决定后面怎么继续。",
            ),
        ),
        (
            "photo",
