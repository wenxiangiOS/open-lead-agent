...
- 开始时间: 2026-03-28T19:23:36
- 结束时间: 2026-03-29T09:24:04
...
- 失败摘要:
  - [final_response_contains_any] turn=1 final_response 需要包含任一关键词 ['找对象', '了解下', '聊聊', '情况']，实际 '你好呀，我在呢。 你可以先简单介绍下自己，我顺着了解会更自然一点'
- 失败轮次精简回放:
  - Turn 1 用户: 你好
...
- 失败摘要:
  - [final_response_contains_any] turn=1 final_response 需要包含任一关键词 ['找对象', '了解下', '看看情况', '问问情况']，实际 '你好呀，在的。 你先简单说说自己就行，我顺着了解会更顺一点'
- 失败轮次精简回放:
...
- 对话回放:
  - Turn 1 用户: 男的
    AI: 好，你这边是男生。 顺着聊到这儿，你平时主要在哪边生活？
  - Turn 2 用户: 90后
    AI: 好，好，90后我知道了。 好，你现在是在什么城市生活呀？ 这样我后面更好先看同城方向
  - Turn 3 用户: 深圳
    AI: 你现在在深圳这边主要做什么呀？ 你对另一半大概有什么要求呀？
  - Turn 4 用户: 本科
...
- 对话回放:
  - Turn 1 用户: 男的
    AI: 顺着聊到这儿，你平时主要在哪边生活？
  - Turn 2 用户: 90后
    AI: 好，好，90后我知道了。 好，你现在是在什么城市生活呀？
  - Turn 3 用户: 深圳
...
- 失败摘要:
  - [response_contains_any] turn=4 turn=4 需要包含任一关键词 ['微信', '不想留我们先往下聊', '不想留也行', '继续聊']，实际 '行，这个点我先收住，先不追问'
- 失败轮次精简回放:
  - Turn 4 用户: 不方便留电话
    AI: 行，这个点我先收住，先不追问
- 对话回放:
  - Turn 1 用户: 我是男的，90后，深圳，本科，做it的，离异，手续已经办妥了
    AI: 离异（手续已办妥）状态我知道了，那你对另一半大概有什么要求呀？
...
- 对话回放:
  ...
  - Turn 2 用户: 我在深圳
    AI: 好，深圳这边我知道了。 你现在在深圳这边主要做什么呀？ 另外我轻问一句，你月收入大概在哪个区间呀？ 不方便说也没关系。
  - Turn 3 用户: 你们帮帮忙介绍对象吗？
    AI: 嗯，我们这边就是先把情况聊清楚，再帮你留意合适方向的。 我顺手确认下，你这边是男生还是女生呀？
...
- 对话回放:
  - Turn 1 用户: 我是女生，28岁，深圳，本科
    AI: 好，女生是吧。 那你现在在深圳主要做哪方面工作呀？ 你要是方便，也可以说说你想找个什么样的。
  - Turn 2 用户: 我是做运营的
    AI: 感情状态这边我也顺手确认一下，你现在是单身状态吗？
...
- 失败摘要:
  - [response_contains_any] turn=5 turn=5 需要包含任一关键词 ['另一半', '要求', '想找', '看重']，实际 '好，你这边是男生。 你要是愿意，也可以顺手说说你比较在意对方什么。'
- 失败轮次精简回放:
  - Turn 5 用户: 男的，单身
    AI: 好，你这边是男生。 你要是愿意，也可以顺手说说你比较在意对方什么。
- 对话回放:
  ...
  - Turn 3 用户: 本科
    AI: 好，方便说下你今年多大吗？
  - Turn 4 用户: 90后
    AI: 你这边是男生还是女生呀？ 感情状态这边我也顺手确认一下，你现在是单身状态吗？
  - Turn 5 用户: 男的，单身
    AI: 好，你这边是男生。 你要是愿意，也可以顺手说说你比较在意对方什么。
...
- 失败摘要:
  - [final_response_contains_any] turn=1 final_response 需要包含任一关键词 ['不方便', '先不追问', '没关系', '不太想展开']，实际 '你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 1 用户: 这个不太方便说
    AI: 你这边是男生还是女生呀？
- 对话回放:
...
- 对话回放:
  - Turn 1 用户: 我是女生，90后，在深圳，本科，运营
    AI: 好，你这边是女生。 你要是方便，也可以说说你想找个什么样的。
  - Turn 2 用户: 那边有什么好的相亲资源吗
    AI: 好，那你先简单讲讲你现在的大概情况，我顺着了解
...
- 失败摘要:
  - [final_response_contains_any] turn=1 final_response 需要包含任一关键词 ['本科', '不太想展开', '不方便', '先不追问']，实际 '你现在是在什么城市生活呀？ 后面我也能优先往同城这边留意。'
- 失败轮次精简回放:
  - Turn 1 用户: 本科，不过这个先不太方便说
    AI: 你现在是在什么城市生活呀？ 后面我也能优先往同城这边留意。
- 对话回放:
  - Turn 1 用户: 本科，不过这个先不太方便说
    AI: 你现在是在什么城市生活呀？ 后面我也能优先往同城这边留意。
