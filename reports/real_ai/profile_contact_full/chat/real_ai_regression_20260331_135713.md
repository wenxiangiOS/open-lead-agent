...
- 开始时间: 2026-03-31T12:51:48
- 结束时间: 2026-03-31T13:57:13
...
- `FAIL` `listener_first_service_confirmation_uses_open_self_intro` | category=`humanlike_listener_first` | tags=`critical, humanlike, listener_first, faq, open_self_intro`
...
- `PASS` `policy_memory_reuse_location` | category=`policy_memory` | tags=`memory, reuse`
...
- 断言通过: 2/3
- 建议修改方向: 优先检查提示词、固定话术模板、规则改写和响应清洗。
- 单场景重跑: `python3 scripts/run_real_ai_regression.py --scenario-file /Users/eric/Desktop/doubao_mcp_server/tests/real_ai/scenarios/humanlike_listener_first_regression.json --scenario-id listener_first_unstable_opening_clarify_probe_intent --verbose`
- 失败摘要:
  - [final_response_not_contains_any] turn=1 final_response 不应包含关键词 ['男生还是女生']，实际 '我这句有点没看懂，你是想找对象，还是先了解下呀？ 我再确认一下，你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 1 用户: 佃�好
    AI: 我这句有点没看懂，你是想找对象，还是先了解下呀？ 我再确认一下，你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 佃�好
    AI: 我这句有点没看懂，你是想找对象，还是先了解下呀？ 我再确认一下，你这边是男生还是女生呀？
...
- 断言通过: 2/3
- 建议修改方向: 优先检查提示词、固定话术模板、规则改写和响应清洗。
- 单场景重跑: `python3 scripts/run_real_ai_regression.py --scenario-file /Users/eric/Desktop/doubao_mcp_server/tests/real_ai/scenarios/humanlike_listener_first_regression.json --scenario-id listener_first_opening_clarify_then_soft_intent_self_intro --verbose`
- 失败摘要:
  - [response_not_contains_any] turn=2 turn=2 不应包含关键词 ['男生还是女生']，实际 '好，你也可以先简单介绍下自己，我先了解下你的情况。 我再确认一下，你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 2 用户: 先了解下
    AI: 好，你也可以先简单介绍下自己，我先了解下你的情况。 我再确认一下，你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 佃�好
    AI: 我这句有点没看懂，你是想找对象，还是先了解下呀？ 你这边是男生还是女生呀？
  - Turn 2 用户: 先了解下
    AI: 好，你也可以先简单介绍下自己，我先了解下你的情况。 我再确认一下，你这边是男生还是女生呀？
...
- 失败摘要:
  - [final_response_contains_any] turn=1 final_response 需要包含任一关键词 ['找对象', '了解下', '看看情况', '问问情况']，实际 '好，那你先简单讲讲你现在的大概情况，我顺着了解。 你这边是男生还是女生呀？'
  - [final_response_not_contains_any] turn=1 final_response 不应包含关键词 ['男生还是女生']，实际 '好，那你先简单讲讲你现在的大概情况，我顺着了解。 你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 1 用户: 你好呀，在吗在吗呀呀呀？
    AI: 好，那你先简单讲讲你现在的大概情况，我顺着了解。 你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 你好呀，在吗在吗呀呀呀？
    AI: 好，那你先简单讲讲你现在的大概情况，我顺着了解。 你这边是男生还是女生呀？
...
- 断言通过: 1/2
- 建议修改方向: 优先检查提示词、固定话术模板、规则改写和响应清洗。
- 单场景重跑: `python3 scripts/run_real_ai_regression.py --scenario-file /Users/eric/Desktop/doubao_mcp_server/tests/real_ai/scenarios/humanlike_listener_first_regression.json --scenario-id listener_first_noisy_greeting_clarify --verbose`
- 失败摘要:
  - [final_response_not_contains_any] turn=1 final_response 不应包含关键词 ['男生还是女生']，实际 '我这句有点没看懂，你是想找对象，还是先了解下呀？ 我再确认一下，你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 1 用户: 你好呀，坏呼叫
...
- 断言通过: 2/3
- 建议修改方向: 优先检查提示词、固定话术模板、规则改写和响应清洗。
- 单场景重跑: `python3 scripts/run_real_ai_regression.py --scenario-file /Users/eric/Desktop/doubao_mcp_server/tests/real_ai/scenarios/humanlike_listener_first_regression.json --scenario-id listener_first_opening_probe_particle_soft_intent_self_intro --verbose`
- 失败摘要:
  - [response_not_contains_any] turn=2 turn=2 不应包含关键词 ['男生还是女生']，实际 '行呀，那你可以先简单说说自己，我先顺着了解下你的情况。 你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 2 用户: 先了解下呢
    AI: 行呀，那你可以先简单说说自己，我先顺着了解下你的情况。 你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 你好
    AI: 行呀，那你可以先简单说说自己，我先顺着了解下你的情况。 你好呀，我在呢。 你这边是男生还是女生呀？
  - Turn 2 用户: 先了解下呢
    AI: 行呀，那你可以先简单说说自己，我先顺着了解下你的情况。 你这边是男生还是女生呀？
...
- 对话回放:
  - Turn 1 用户: 你好
    AI: 好，你也可以先简单介绍下自己，我先了解下你的情况。 在的，我接着了解下，你这边是男生还是女生呀？
  - Turn 2 用户: 我先看看
    AI: 好，你也可以先简单介绍下自己，我先了解下你的情况。 我再确认一下，你这边是男生还是女生呀？
...
- 失败摘要:
  - [response_not_contains_any] turn=2 turn=2 不应包含关键词 ['男生还是女生']，实际 '好，你也可以先简单介绍下自己，我先了解下你的情况。 你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 2 用户: 就是想先问问情况呢
    AI: 好，你也可以先简单介绍下自己，我先了解下你的情况。 你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 你好
    AI: 好，你也可以先简单介绍下自己，我先了解下你的情况。 在呢，你这边是男生还是女生呀？
  - Turn 2 用户: 就是想先问问情况呢
    AI: 好，你也可以先简单介绍下自己，我先了解下你的情况。 你这边是男生还是女生呀？
...
- 失败摘要:
  - [response_not_contains_any] turn=2 turn=2 不应包含关键词 ['男生还是女生']，实际 '好，那你先简单讲讲你现在的大概情况，我顺着了解。 我再确认一下，你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 2 用户: 我问问你情况呢
    AI: 好，那你先简单讲讲你现在的大概情况，我顺着了解。 我再确认一下，你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 你好
    AI: 行呀，那你可以先简单说说自己，我先顺着了解下你的情况。 你好呀，我在呢。 你这边是男生还是女生呀？
  - Turn 2 用户: 我问问你情况呢
...
- 失败摘要:
  - [response_contains_any] turn=2 turn=2 需要包含任一关键词 ['可以', '不强求', '不留也行', '先聊']，实际 '男生，我大概清楚了。 这个我先放这儿，我们先按你舒服的节奏来。 行，我明白你这会儿不太方便。 这块我先不追问，我们先顺着你舒服一点的节奏来'
- 失败轮次精简回放:
  - Turn 2 用户: 不给电话行不行，我是男的
    AI: 男生，我大概清楚了。 这个我先放这儿，我们先按你舒服的节奏来。 行，我明白你这会儿不太方便。 这块我先不追问，我们先顺着你舒服一点的节奏来
- 对话回放:
  - Turn 1 用户: 你好
    AI: 行呀，那你可以先简单说说自己，我先顺着了解下你的情况。 在呢，你这边是男生还是女生呀？
  - Turn 2 用户: 不给电话行不行，我是男的
    AI: 男生，我大概清楚了。 这个我先放这儿，我们先按你舒服的节奏来。 行，我明白你这会儿不太方便。 这块我先不追问，我们先顺着你舒服一点的节奏来

### listener_first_service_confirmation_uses_open_self_intro

- 场景文件: `/Users/eric/Desktop/doubao_mcp_server/tests/real_ai/scenarios/humanlike_listener_first_regression.json`
- 分类: `humanlike_listener_first`
- 标签: `critical, humanlike, listener_first, faq, open_self_intro`
- 描述: 用户首轮确认是不是帮忙介绍对象时，应直接答服务性质并给开放自述入口，不要慢速进主模型后改问性别。
- 断言通过: 1/2
- 建议修改方向: 优先检查提示词、固定话术模板、规则改写和响应清洗。
- 单场景重跑: `python3 scripts/run_real_ai_regression.py --scenario-file /Users/eric/Desktop/doubao_mcp_server/tests/real_ai/scenarios/humanlike_listener_first_regression.json --scenario-id listener_first_service_confirmation_uses_open_self_intro --verbose`
- 失败摘要:
  - [final_response_not_contains_any] turn=1 final_response 不应包含关键词 ['男生还是女生']，实际 '可以的，你先说说自己的情况，我这边顺着了解就行。 我再确认一下，你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 1 用户: 你们帮帮忙介绍对象吗？
    AI: 可以的，你先说说自己的情况，我这边顺着了解就行。 我再确认一下，你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 你们帮帮忙介绍对象吗？
    AI: 可以的，你先说说自己的情况，我这边顺着了解就行。 我再确认一下，你这边是男生还是女生呀？
...
- 对话回放:
  - Turn 1 用户: 男的
    AI: 男生，我大概清楚了。 好，你现在主要在哪个城市生活呀？
  - Turn 2 用户: 90后
    AI: 挺好的呀，你最高学历是啥？
  - Turn 3 用户: 深圳
    AI: 你现在在深圳。 你现在主要做哪方面工作呀？ 说到这儿，你会更看重对方什么？
  - Turn 4 用户: 本科
  ...
  - Turn 6 用户: 我离异过呢
    AI: 电话这块我再轻轻问一句，你要是方便的话，留个常用手机号就行，后面真有合适的，我们也好联系到你。
  - Turn 7 用户: 办理好了
    AI: 要是你愿意，留个电话也行。 像IT这类工作，你现在月收入大概在哪一档呀？
  - Turn 8 用户: 你不问其他了？
    AI: 对，我们先把联系方式这条说清楚，其他信息先不往里插
...
- 失败摘要:
  - [response_contains_any] turn=3 turn=3 需要包含任一关键词 ['工作', '做什么', '做哪方面']，实际 '是的，我们这边就是帮忙介绍的。 我再确认一下，你这边是男生还是女生呀？ 你这边是男生还是女生呀？'
  - [response_not_contains_any] turn=3 turn=3 不应包含关键词 ['男生还是女生']，实际 '是的，我们这边就是帮忙介绍的。 我再确认一下，你这边是男生还是女生呀？ 你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 3 用户: 你们帮帮忙介绍对象吗？
    AI: 是的，我们这边就是帮忙介绍的。 我再确认一下，你这边是男生还是女生呀？ 你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 找对象
    AI: 行呀，那你可以先简单说说自己，我先顺着了解下你的情况。 好呀，你也可以先简单介绍下自己，我顺着了解会更自然一点。 或者我先问你一个小问题，你这边是男生还是女生呀？
  - Turn 2 用户: 我在深圳
    AI: 那你现在在深圳主要做哪方面工作呀？ 如果你方便的话，我再补一个小问题：你月收入大概在哪个范围？ 不方便说也没关系。
  - Turn 3 用户: 你们帮帮忙介绍对象吗？
    AI: 是的，我们这边就是帮忙介绍的。 我再确认一下，你这边是男生还是女生呀？ 你这边是男生还是女生呀？
...
- 失败摘要:
  - [final_response_contains_any] turn=1 final_response 需要包含任一关键词 ['电话', '微信', '联系']，实际 '你做运营这行的话，收入大概在哪个范围？'
- 失败轮次精简回放:
  - Turn 1 用户: 我是女生，90后，深圳，本科，运营，单身，想找男生
    AI: 你做运营这行的话，收入大概在哪个范围？
- 对话回放:
  - Turn 1 用户: 我是女生，90后，深圳，本科，运营，单身，想找男生
    AI: 你做运营这行的话，收入大概在哪个范围？
...
- 失败摘要:
  - [response_contains_any] turn=3 turn=3 需要包含任一关键词 ['怎么了', '顾虑', '担心', '不想继续聊', '不想继续']，实际 '我再确认一下，你这边是男生还是女生呀？ 你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 3 用户: 不聊了
    AI: 我再确认一下，你这边是男生还是女生呀？ 你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 找对象
    AI: 好，那你先简单讲讲你现在的大概情况，我顺着了解。 行呀，那我先认识下你。 你也可以先简单说说自己，我这边顺着了解会更顺一点；要不我先问你，你这边是男生还是女生呀？
  - Turn 2 用户: 我在深圳，今年29岁
    AI: 深圳现在发展机会挺多的，生活氛围也很不错~ 你目前是什么学历呀，现在是单身状态吗？
  - Turn 3 用户: 不聊了
    AI: 我再确认一下，你这边是男生还是女生呀？ 你这边是男生还是女生呀？
...
- 失败摘要:
  - [response_contains_any] turn=4 turn=4 需要包含任一关键词 ['先这样', '不打扰', '先收住', '想继续聊', '再来找我']，实际 '你这边是男生还是女生呀？ 我再确认一下，你这边是男生还是女生呀？'
- 失败轮次精简回放:
  - Turn 4 用户: 还是先不聊了
    AI: 你这边是男生还是女生呀？ 我再确认一下，你这边是男生还是女生呀？
- 对话回放:
  - Turn 1 用户: 找对象
    AI: 好，你也可以先简单介绍下自己，我先了解下你的情况。 好呀，你也可以先简单介绍下自己，我顺着了解会更自然一点。 或者我先问你一个小问题，你这边是男生还是女生呀？
  - Turn 2 用户: 我在深圳，今年29岁
    AI: 现在主要在深圳。 你的学历背景大概是怎样的？
  - Turn 3 用户: 不聊了
    AI: 我再确认一下，你这边是男生还是女生呀？ 你这边是男生还是女生呀？
  - Turn 4 用户: 还是先不聊了
    AI: 你这边是男生还是女生呀？ 我再确认一下，你这边是男生还是女生呀？
...
- 失败摘要:
  - [response_contains_any] turn=2 turn=2 需要包含任一关键词 ['等好消息', '提前约时间', '不打扰', '联系前']，实际 '你前面提过更偏向温柔这一类，这个我知道。 你做IT这行的话，收入大概在哪个范围？'
- 失败轮次精简回放:
  - Turn 2 用户: 不聊了
    AI: 你前面提过更偏向温柔这一类，这个我知道。 你做IT这行的话，收入大概在哪个范围？
- 对话回放:
  - Turn 1 用户: 我是男的，90后，在深圳，本科，做IT的，单身，想找温柔点的，我电话17688654321
    AI: 你前面提过更偏向温柔这一类，这个我知道。 你这边是男生。 这个我有数了。 对，刚刚是在说微信这块。 你要是愿意的话，留个常用微信就行，不想留也没关系
  - Turn 2 用户: 不聊了
    AI: 你前面提过更偏向温柔这一类，这个我知道。 你做IT这行的话，收入大概在哪个范围？
