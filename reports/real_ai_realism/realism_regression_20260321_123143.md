...
- general: avg=1.679s p95=1.758s max=1.762s n=5
- 秒回率(<1s): 0.0%
- FAQ秒回率(<1s): 0.0%
- 超慢回复率(>20s): 0.0%
...
- age_matches_user_stated
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_512ebe5d', 'expected': '90后', 'actual': 30, 'note': ''}
### policy
- medium_ask_limit_partner_requirement
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_512ebe5d', 'expected': '<=1', 'actual': 3, 'note': ''}
- no_consecutive_same_field_ask
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_512ebe5d', 'expected': 0, 'actual': 1, 'note': ''}
...
- 失败检查数: 1
- 通过率: 91.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_512ebe5d): ["age_matches_user_stated: expected='90后', actual=30"]
...
- 失败检查数: 2
- 通过率: 86.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_512ebe5d): ["medium_ask_limit_partner_requirement: expected='<=1', actual=3", 'no_consecutive_same_field_ask: expected=0, actual=1']
