...
- general: avg=1.78s p95=2.043s max=2.075s n=5
- 秒回率(<1s): 0.0%
- FAQ秒回率(<1s): 0.0%
- 超慢回复率(>20s): 0.0%
...
- age_matches_user_stated
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_93d96c0d', 'expected': '90后', 'actual': 30, 'note': ''}
### policy
- medium_ask_limit_partner_requirement
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_93d96c0d', 'expected': '<=1', 'actual': 3, 'note': ''}
- no_consecutive_same_field_ask
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_93d96c0d', 'expected': 0, 'actual': 1, 'note': ''}

## 基线对比

- 检测到退化指标：
- latency_p95: current=2.043 baseline=1.992
...
- P1失败数: 1
- P2失败数: 0
- [P1] baseline_degradation::latency_p95: value=2.043 target=1.992
...
- 失败项数量: 1
- 严重失败项数量: 0
- [major] baseline_degradation::latency_p95: value=2.043 target=1.992
...
- 失败检查数: 1
- 通过率: 91.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_93d96c0d): ["age_matches_user_stated: expected='90后', actual=30"]
...
- 失败检查数: 2
- 通过率: 86.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_93d96c0d): ["medium_ask_limit_partner_requirement: expected='<=1', actual=3", 'no_consecutive_same_field_ask: expected=0, actual=1']
