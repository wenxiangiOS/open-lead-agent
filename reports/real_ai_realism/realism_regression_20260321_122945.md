...
- total: 1.6165s
- response_build: 1.2467s
- rule_check: 0.3609s
- context_load: 0.0036s
- extract_collect: 0.0031s
- other: 0.0027s
...
- general: avg=1.616s p95=1.992s max=2.041s n=5
- 秒回率(<1s): 0.0%
- FAQ秒回率(<1s): 0.0%
- 超慢回复率(>20s): 0.0%
...
- age_matches_user_stated
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_a8971264', 'expected': '90后', 'actual': 30, 'note': ''}
### policy
- medium_ask_limit_partner_requirement
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_a8971264', 'expected': '<=1', 'actual': 3, 'note': ''}
- no_consecutive_same_field_ask
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_a8971264', 'expected': 0, 'actual': 1, 'note': ''}

## 基线对比

- 检测到退化指标：
- humanlike_pass_rate: current=0.9 baseline=0.9968
- extraction_pass_rate: current=0.9167 baseline=0.9275
...
- P1失败数: 2
- P2失败数: 0
- [P1] baseline_degradation::humanlike_pass_rate: value=0.9 target=0.9968
- [P1] baseline_degradation::extraction_pass_rate: value=0.9167 target=0.9275
...
- 失败项数量: 3
- 严重失败项数量: 0
- [major] baseline_degradation::humanlike_pass_rate: value=0.9 target=0.9968
- [major] baseline_degradation::extraction_pass_rate: value=0.9167 target=0.9275
...
- 1 次 (20.0%): `这个偏好我先记住啦你更看重对方哪几点呀我按你的要求来筛`
...
- 失败检查数: 1
- 通过率: 91.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_a8971264): ["age_matches_user_stated: expected='90后', actual=30"]
...
- 失败检查数: 2
- 通过率: 86.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_a8971264): ["medium_ask_limit_partner_requirement: expected='<=1', actual=3", 'no_consecutive_same_field_ask: expected=0, actual=1']
