...
- total: 1.3967s
- rule_check: 1.3436s
- response_build: 1.134s
- ai_call: 0.2351s
- context_load: 0.0035s
- other: 0.0029s
- profile_save: 0.0002s
- extract_collect: 0.0002s
- profile_load: 0.0001s

## 意图分桶时延

- general: avg=1.397s p95=2.096s max=2.147s n=5
- 秒回率(<1s): 20.0%
- FAQ秒回率(<1s): 0.0%
- 超慢回复率(>20s): 0.0%
...
- reply_too_fast_nonhuman
  - {'turn': 3, 'user': '好的', 'assistant': '收到，你刚这句我先接住。我们先按你在意的点继续聊，不急着留联系方式。', 'latency_s': 0.256, 'perf': {'profile_load': 0.0, 'context_load': 0.0038, 'rule_check': 0.0017, 'profile_save': 0.0003, 'ai_call': 0.2351, 'extract_collect': 0.0002, 'response_build': 0.0001, 'other': 0.0147, 'total': 0.256}}
### field
### policy
- no_consecutive_same_field_ask
  - {'scenario_id': 'abuse_repeated_ack_should_not_loop_contact', 'session_id': 'realism_1_d53c5924', 'expected': 0, 'actual': 1, 'note': ''}

## 基线对比

- 检测到退化指标：
- humanlike_pass_rate: current=0.9 baseline=0.9708
- template_top1_ratio: current=0.4 baseline=0.3026
...
- [P1] baseline_degradation::humanlike_pass_rate: value=0.9 target=0.9708
...
- [major] baseline_degradation::humanlike_pass_rate: value=0.9 target=0.9708
- [major] baseline_degradation::template_top1_ratio: value=0.4 target=0.3026

## 模板化风险 Top10

- 2 次 (40.0%): `电话只是留作登记和后面联系不会拿去做别的你要是方便的话发我一个号码就行`
- 1 次 (20.0%): `你好呀在的我可以先快速了解你两三点也可以先听你说想找什么类型你更想先聊哪边`
- 1 次 (20.0%): `嗯...亲是不是不小心输错啦我看到的内容有点看不懂呢`
...
- 失败检查数: 1
- 通过率: 93.3%
- abuse_repeated_ack_should_not_loop_contact (realism_1_d53c5924): ['no_consecutive_same_field_ask: expected=0, actual=1']
