...
- total: 1.4478s
- response_build: 1.2463s
- rule_check: 0.1923s
- context_load: 0.0038s
...
- general: avg=1.448s p95=1.815s max=1.845s n=5
- 秒回率(<1s): 20.0%
- FAQ秒回率(<1s): 0.0%
- 超慢回复率(>20s): 0.0%
...
- age_matches_user_stated
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_e4870fe8', 'expected': '90后', 'actual': 30, 'note': ''}
### policy
- medium_ask_limit_partner_requirement
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_e4870fe8', 'expected': '<=1', 'actual': 3, 'note': ''}
- no_consecutive_same_field_ask
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_e4870fe8', 'expected': 0, 'actual': 1, 'note': ''}

## 基线对比

- 检测到退化指标：
- latency_p95: current=1.815 baseline=1.758
...
- P1失败数: 1
- P2失败数: 0
- [P1] baseline_degradation::latency_p95: value=1.815 target=1.758
...
- 失败项数量: 1
- 严重失败项数量: 0
- [major] baseline_degradation::latency_p95: value=1.815 target=1.758
...
- 失败检查数: 1
- 通过率: 91.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_e4870fe8): ["age_matches_user_stated: expected='90后', actual=30"]
...
- 失败检查数: 2
- 通过率: 86.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_e4870fe8): ["medium_ask_limit_partner_requirement: expected='<=1', actual=3", 'no_consecutive_same_field_ask: expected=0, actual=1']
