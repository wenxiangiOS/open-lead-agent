...
- total: 1.7838s
- response_build: 1.4037s
- rule_check: 0.3683s
- extract_collect: 0.0045s
- context_load: 0.004s
- other: 0.0035s
- profile_save: 0.0011s
- profile_load: 0.0003s

## 意图分桶时延

- general: avg=1.784s p95=1.884s max=1.893s n=5
- 秒回率(<1s): 0.0%
- FAQ秒回率(<1s): 0.0%
- 超慢回复率(>20s): 0.0%
...
- age_matches_user_stated
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_390a20d4', 'expected': '90后', 'actual': 30, 'note': ''}
### policy
- medium_ask_limit_partner_requirement
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_390a20d4', 'expected': '<=1', 'actual': 3, 'note': ''}
- no_consecutive_same_field_ask
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_1_390a20d4', 'expected': 0, 'actual': 1, 'note': ''}

## 基线对比

- 检测到退化指标：
- humanlike_pass_rate: current=0.9 baseline=0.95
...
- P1失败数: 1
- P2失败数: 0
- [P1] baseline_degradation::humanlike_pass_rate: value=0.9 target=0.95
...
- 失败项数量: 1
- 严重失败项数量: 0
- [major] baseline_degradation::humanlike_pass_rate: value=0.9 target=0.95
...
- 失败检查数: 1
- 通过率: 91.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_390a20d4): ["age_matches_user_stated: expected='90后', actual=30"]
...
- 失败检查数: 2
- 通过率: 86.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_1_390a20d4): ["medium_ask_limit_partner_requirement: expected='<=1', actual=3", 'no_consecutive_same_field_ask: expected=0, actual=1']
