...
- general: avg=1.593s p95=2.302s max=2.375s n=10
- 秒回率(<1s): 10.0%
- FAQ秒回率(<1s): 0.0%
- 超慢回复率(>20s): 0.0%
...
- reply_too_fast_nonhuman
  - {'turn': 3, 'user': '好的', 'assistant': '收到，你刚这句我先接住。我们先按你在意的点继续聊，不急着留联系方式。', 'latency_s': 0.236, 'perf': {'profile_load': 0.0, 'context_load': 0.0026, 'rule_check': 0.0009, 'profile_save': 0.0002, 'ai_call': 0.2192, 'extract_collect': 0.0002, 'response_build': 0.0001, 'other': 0.0128, 'total': 0.236}}
### field
- age_matches_user_stated
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_2_fdeb4508', 'expected': '90后', 'actual': 30, 'note': ''}
### policy
- field_interleaving_quality
  - {'scenario_id': 'field_partner_requirement_height_and_age_preference_should_not_end', 'session_id': 'realism_2_fdeb4508', 'expected': '<=3 core asks streak', 'actual': 4, 'note': ''}

## 基线对比

- 检测到退化指标：
- latency_p95: current=2.302 baseline=2.181
...
- P1失败数: 1
- P2失败数: 0
- [P1] baseline_degradation::latency_p95: value=2.302 target=2.181
...
- 失败项数量: 1
- 严重失败项数量: 0
- [major] baseline_degradation::latency_p95: value=2.302 target=2.181

## 模板化风险 Top10

- 1 次 (10.0%): `你好呀在的我可以先快速了解你两三点也可以先听你说想找什么类型你更想先聊哪边`
- 1 次 (10.0%): `亲你是想说什么呢我刚才看到的消息有点奇怪呢`
- 1 次 (10.0%): `收到你刚这句我先接住我们先按你在意的点继续聊不急着留联系方式`
- 1 次 (10.0%): `电话只是留作登记和后面联系不会拿去做别的你要是方便的话发我一个号码就行`
- 1 次 (10.0%): `电话这边主要是方便后面登记和联系你不会私下打扰你的要是你方便的话把号码发我就行`
...
- 失败检查数: 1
- 通过率: 94.1%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_2_fdeb4508): ["age_matches_user_stated: expected='90后', actual=30"]
...
- 失败检查数: 1
- 通过率: 96.7%
- field_partner_requirement_height_and_age_preference_should_not_end (realism_2_fdeb4508): ["field_interleaving_quality: expected='<=3 core asks streak', actual=4"]
